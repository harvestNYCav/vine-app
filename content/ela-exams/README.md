...
- The schema-v4 runtime fails closed unless all 78 year/grade releases, exactly 1,583 released multiple-choice questions, all 242 passage stimuli and reviewed transcripts, 145 unmodified official rationales, 4 explicitly corrected official rationales, and 1,434 Vine-authored explanations are present with valid local assets and provenance.
